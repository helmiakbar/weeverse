# RailsAdmin config file. Generated on November 19, 2013 13:59
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Weeverse', 'Admin']
  ...
  # config.excluded_models = ['Idea', 'Project', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Idea', 'Project', 'User']
  ...
  #   # You can copy this to a 'rails_admin do ... end' block inside your idea.rb model definition
  ...
  #     configure :childrens, :has_many_association 
